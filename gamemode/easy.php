      ...
      <div class="box-container">
        ...
        <?php if (!$game_completed): ?>
          ...
          <?php if ($_SESSION['answered_q1'] && !$_SESSION['answered_q2']): ?>
            <div class="question">
              <p><strong>Question 2:</strong> What is 5 × 10?</p>
              <form method="POST">
                ...
                <div class="options">
                  ...
                  <div class="ansbox"><button type="submit" name="answer" value="10" class="optionsnumber">10</button></div>
                  <div class="ansbox"><button type="submit" name="answer" value="6" class="optionsnumber">6</button></div>
                  <div class="ansbox"><button type="submit" name="answer" value="8" class="optionsnumber">8</button></div>
                </div>
              </form>
          ...
          <?php if ($_SESSION['answered_q2'] && !$_SESSION['answered_q3']): ?>
            <div class="question">
              <p><strong>Question 3:</strong> What is 9 × 10?</p>
              <form method="POST">
          ...
          <?php if ($_SESSION['answered_q3'] && !$_SESSION['answered_q4']): ?>
            <div class="question">
              <p><strong>Question 4:</strong> What is 10 × 10?</p>
              <form method="POST">
          ...
          <?php if ($_SESSION['answered_q4'] && !$_SESSION['answered_q5']): ?>
            <div class="question">
              <p><strong>Question 5:</strong> What is 20 × 10?</p>
              <form method="POST">
                ...
                <div class="options">
                  ...
                  <div class="ansbox"><button type="submit" name="answer" value="400" class="optionsnumber">400</button></div>
                </div>
              </form>
            </div>
          <?php endif; ?>
