            ...
            <div class="box-container">
                ...
                <?php if (!$game_completed): ?>
                    ...
                    <?php if (!$_SESSION['answered_q1']): ?>
                        <div class="question">
                            <p><strong>Question 1:</strong>What gas is essential for combustion?</p>
                            <form method="POST">
                                <input type="hidden" name="question" value="q1">
                                <div class="options">
                                    <div class="ansbox"><button type="submit" name="answer" value="oxygen" class="optionsnumber">oxygen</button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="gas" class="optionsnumber"> gas</button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="nepal" class="optionsnumber">nepal</button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="mud" class="optionsnumber">mud</button></div>
                                </div>
                            </form>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($_SESSION['answered_q1'] && !$_SESSION['answered_q2']): ?>
                        <div class="question">
                            <p><strong>Question 2:</strong>What is the chemical symbol for water?</p>
                            <form method="POST">
                                <input type="hidden" name="question" value="q2">
                                <div class="options">
                                    <div class="ansbox"><button type="submit" name="answer" value="co2" class="optionsnumber">co2</button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="H2O" class="optionsnumber">H2O</button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="HO2" class="optionsnumber">HO2</button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="2HO" class="optionsnumber">2HO</button></div>
                                </div>
                            </form>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($_SESSION['answered_q2'] && !$_SESSION['answered_q3']): ?>
                        <div class="question">
                            <p><strong>Question 3:</strong> What is the force that pulls objects towards the Earth?</p>
                            <form method="POST">
                                <input type="hidden" name="question" value="q3">
                                <div class="options">
                                    <div class="ansbox"><button type="submit" name="answer" value="navity" class="optionsnumber">navity</button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="UNO" class="optionsnumber">UNO</button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="cavity" class="optionsnumber">cavity</button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="Gravity" class="optionsnumber">Gravity</button></div>
                                </div>
                            </form>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($_SESSION['answered_q3'] && !$_SESSION['answered_q4']): ?>
                        <div class="question">
                            <p><strong>Question 4:</strong>What is the study of earthquakes called?</p>
                            <form method="POST">
                                <input type="hidden" name="question" value="q4">
                                <div class="options">
                                    <div class="ansbox"><button type="submit" name="answer" value="trust" class="optionsnumber">trust</button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="thrust" class="optionsnumber">thrust </button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="mantal" class="optionsnumber">mantal</button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="crust" class="optionsnumber">crust</button></div>
                                </div>
                            </form>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($_SESSION['answered_q4'] && !$_SESSION['answered_q5']): ?>
                        <div class="question">
                            <p><strong>Question 5:</strong> What is the process of plants making their own food called?</p>
                            <form method="POST">
                                <input type="hidden" name="question" value="q5">
                                <div class="options">
                                    <div class="ansbox"><button type="submit" name="answer" value="red" class="optionsnumber">red</button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="dead" class="optionsnumber">dead</button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="pacific" class="optionsnumber">pacific</button></div>
                                    <div class="ansbox"><button type="submit" name="answer" value="koshi" class="optionsnumber">koshi</button></div>
                                </div>
                            </form>
                        </div>
                    <?php endif; ?>
